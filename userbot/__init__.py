...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/1e5c2f295cc1049e5ab41.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/1e5c2f295cc1049e5ab41.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "**Duta-Xbot Sudah Aktif **\n\n **Branch :** `Duta-Xbot`\n **BotVer :** `5.0`\n\n **Support :** @call_mee_duta\n")
    return
...
# ====================================InlineHandler===================================== #
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    f" __Saya Adalah Duta Xbot Yang Digunakan Banyak User Telegram__.\n\n"
                ...
                await event.edit(
                    ...
                    link_preview=True,
                    buttons=[
                        [custom.Button.inline("", data="closed")],
                    ]
                )
            else:
            ...
            if event.query.user_id == uid:
                ...
                await event.edit(
                    ...
                    buttons=[
                        ...
                        [custom.Button.inline("", data="pmbot")],
                        [custom.Button.inline(
                            "  ", data="inline_mode")],
                ...
                await event.edit(
                    ...
                    buttons=[
                        [
                            ...
                            custom.Button.inline(
                                ">>", data="closed")],
                        [custom.Button.inline("   ", data="catatan_2")],
                    ]
                )
            else:
                reply_pop_up_alert = f" DISCLAIMER \n\nAnda Tidak Mempunyai Hak Untuk Menekan Tombol Button Ini"
