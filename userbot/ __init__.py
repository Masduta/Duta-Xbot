...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "**DUT-XT RHSIL DITI**\n\n **Branch :** `Duta_Xbot`\n **BotVer :** `5.0`\n\n **Support :** @fourBrothersgroup\n")
    return
                ...
                await event.reply(
                    ...
                    buttons=[
                        [
                            ...
                            Button.url("",
                                       "https://github.com/Masduta/Duta-Xbot/LICENSE")],
                        [Button.url("",
            ...
            if event.query.user_id == uid:
                ...
                await event.edit(
                    ...
                    buttons=[
                        ...
                        [Button.inline("_", data="userbot_support")],
                    ]
                )
            else:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"`.set var XBOT_TEKS_KUSTOM` <teks>\n\n"
                    f"© @fourBrothersgroup")
                await event.edit(
                    text,
                    file=dutalogo,
...
# ====================================OwnerTools===================================== #
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    f"**{DUTA-XBOT_TEKS_KUSTOM}**\n\n"
                    f"\n"
                    f" **Pemilik** - `{DEFAULTUSER}`\n"
                    f" **Versi** - `5.0`\n"
                    f" **Groups** - @fourBrothrsgroup\n"
                    f" **Bahasa** - `Python`\n"
                    f" **Branch** - `Duta-Xbot`\n"
                    f" **Modules** - `170`\n"
                    f"")
