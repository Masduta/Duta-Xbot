...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC",
    None) or "https://telegra.ph/file/5ad43cccefd02287d4b03.jpg"
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/Masduta/Duta-Xbot")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "Duta-Xbot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/5ad43cccefd02287d4b03.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/5ad43cccefd02287d4b03.jpg"

# Default Video welcome
WELCOME_PIC = os.environ.get(
    "WELCOME_PIC") or "https://telegra.ph/file/5ad43cccefd02287d4b03.jpg"
...
# °ROSE-USERBOT°
OWNER_URL = os.environ.get("OWNER_URL") or "https://t.me/call_mee_duta"
...
# ====================================InlineHandler===================================== #
        ...
        async def starte(event):
            text = (
                f"Join Groups Support @fourBrothersgroub")
            await event.edit(
                text,
                link_preview=True,
                buttons=[
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                ...
                await event.edit(
                    ...
                    buttons=[
                        [
                            Button.inline(" ", data="start"),
                            Button.inline("  ", data="settings"),
                        ],
                        [
                            Button.inline("  ", data="owner_tools"),
                            Button.inline("  ", data="pmon_pmof"),
                        ],
                        [Button.inline(" Duta Xbot ", data="userbot_support")],
                    ]
                )
            else:
                reply_pop_up_alert = f" DISCLAIMER \n\nHanya {DEFAULTUSER}Yang Bisa Menekan Tombol Ini, Deploy Duta Xbot Untuk Mengetahui Fitur Nya."
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                ...
                await event.edit(
                    ...
                    buttons=[
                        [
                            Button.inline(" ", data="apiset"),
                            Button.inline(" ", data="chatbot"),
                        ],
                        [
                            Button.inline("", data="alvcstm"),
                            Button.inline(" ", data="ppmset"),
                        ],
                        [Button.inline("", data="otvars")],
                        [Button.inline("", data="vcb")],
                        [Button.inline("« B", data="menu")],
                    ]
                )
            else:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                ...
                await event.edit(
                    ...
                    link_preview=True,
                    buttons=[
                        [custom.Button.inline("", data="pembaruan")],
                        [custom.Button.inline("", data="alive")],
                        [custom.Button.inline("", data="permirt")],
                        [custom.Button.inline(
                            "  ", data="inline_mode")],
                        [custom.Button.inline("", data="menu")],
                    ]
                )
            else:
                reply_pop_up_alert = f" DISCLAIMER \n\nAnda Tidak Mempunyai Hak Untuk Menekan Tombol Button Ini"
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"** Owner: ** {DEFAULTUSER}\n\n"
                    f" **Penjelasan :**\n"
                    f"__Jika Kamu Mengaktifkan Pmpermit Kamu KeTrue, Otomatis Pmpermit Kamu Akan Aktif Bawaan Langsung Dari Duta-Xbot.__\n\n"
                    f" **Description :**\n"
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"** Owner: ** {DEFAULTUSER}\n\n"
                    f" **Penjelasan :**\n"
                    f"__Kamu Dapat Mengecek Pembaruan Untuk Duta-Xbot, Agar Dapat Menikmati Fitur Terbaru.__\n\n"
                    f" **Description :**\n"
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                ...
                await event.edit(
                    ...
                    link_preview=True,
                    buttons=[
                        [custom.Button.inline(" ", data="open_plugin")],
                        [custom.Button.inline(" ", data="rose")],
                        [custom.Button.inline("", data="ping")],
                        [custom.Button.inline("<<", data="menu")],
                    ]
                )
            else:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # userbot
                ...
                await event.edit(
                    ...
                    buttons=[
                        [
                            Button.url(f"{EMOJI_HELP}  {EMOJI_HELP} ",
                                       "t.me/fourBrothersgroup"),
                            Button.url(f"{EMOJI_HELP}  {EMOJI_HELP} ",
                                       "t.me/call_mee_duta")],
                        [Button.url(f"{EMOJI_HELP}  {EMOJI_HELP} ",
                            ...
                            Button.url(f"{EMOJI_HELP}  {EMOJI_HELP} ",
                                       f"{IG_ALIVE}")],
                        [custom.Button.inline(
                            f"{EMOJI_HELP}  {EMOJI_HELP}", b"close")],
                    ]
                )
