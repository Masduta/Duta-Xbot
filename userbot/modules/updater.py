...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit('**👻Duta-Xbot👻** `Berhasil Di Update!`')
    await asyncio.sleep(1)
    await event.edit('**👻Duta-Xbot👻** `Di Restart....`')
    await asyncio.sleep(1)
...
async def upstream(event):
    ...
    if changelog == '' and force_update is False:
        await event.edit(
            f'\n👻Duta-Xbot👻 Sudah Versi Terbaru || Tunggu Update Terbaru\n')
        await asyncio.sleep(15)
        await event.delete()
        return repo.__del__()

    if conf is None and force_update is False:
        changelog_str = f'**Pembaruan Untuk 👻Duta-Xbot👻 :\n\n⚒️ Pembaruan Data :**\n`{changelog}`'
    ...
    if force_update:
        ...
        await event.edit('` Proses Update 👻Duta-Xbot👻, Loading....1%`')
        await event.edit('` Proses Update 👻Duta-Xbot👻,Loading....20%`')
        await event.edit('` Proses Update 👻Duta-Xbot👻, Loading....35%`')
        await event.edit('` Proses Update 👻Duta-Xbot👻, Loading....77%`')
        await event.edit('` Proses Update 👻Duta-Xbot👻, Updating...90%`')
        await event.edit('` Proses Update 👻Duta-Xbot👻, Mohon Tunggu Sebentar....100%`')
