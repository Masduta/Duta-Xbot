...
@register(outgoing=True, pattern=r"^\.(?:xbotalive)\s?(.)?")
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━━━━━━━━━━✠╯\n"
        f"[ɢʀᴏᴜᴘꜱ](https://t.me/fourBrothersgroup) | [ʙᴏᴛᴏꜰ](https://t.me/{user.username}) | [ɢɪᴛʜᴜʙ](https://github.com/Masduta/Duta-Xbot)")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
...
@register(outgoing=True, pattern=r"^\.(?:dutabot)\s?(.)?")
async def amireallyalive(alive):
    await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    output = (
        f"●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬● \n"
        f"✾ 🤴 • `ᴏᴡɴᴇʀ :`[Duta](t.me/call_mee_duta)             ㅤ \n"
...
async def redis(alive):
    ...
    output = (
        ...
        f"┃✱ **GitHub   :** [Github](https://github.com/Masduta/Duta-Xbot) \n"
        f"┃✱ **Groups   :** [Groups](https://t.me/fourBrothersgroup) \n"
        f"┃✱ **Owner    :** [Duta](https://t.me/call_mee_duta) \n"
        f"╰✠╼━━━━━━━━━━━━━━━━━━━✠╯")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
