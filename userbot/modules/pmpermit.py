...
CUSTOM_TEXT = str(
    PMPERMIT_TEXT) if PMPERMIT_TEXT else f"__Halo kawan, saya bot yang menjaga room chat 👻Duta-Xbot👻 {DEFAULTUSER} di mohon jangan melakukan spam , kalau anda melakukan itu OTOMATIS saya akan memblockir anda!__ \n"
DEF_UNAPPROVED_MSG = (
    "╔═════════════════════╗\n"
